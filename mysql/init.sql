...
DROP DATABASE IF EXISTS `QAsportarticles`;
CREATE DATABASE `QAsportarticles`;
USE `QAsportarticles`;
...
CREATE TABLE `vat` (
  `type` CHAR(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL PRIMARY KEY,
...
CREATE TABLE `sports_articles` (
    ...
    `stock_quantity` INT,
    `stock_min` INT,
    `VAT_type` CHAR(1) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
    CONSTRAINT `fk_sports_articles_vat` FOREIGN KEY (`VAT_type`) REFERENCES `vat`(`type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(23, 'Volleyball Net', 'Accessory', 'Standard', 'White', 75.00, 10, 5, 'l'),
...
(209, 'VOETBAL', 'BAL', 'Size', 'Color', 0.00, 0, 0, 'h'),
...
(255, 'BASKETBAL', 'Bal', 'Size', 'Color', 0.00, 0, 0, 'h'),
...
(262, 'HULAHOEP', 'Fitness', 'Size', 'Color', 10.00, 0, 0, 'h'),
...
(281, 'Product Name 281', 'Category', 'Size', 'Color', 0.00, 0, 0, 'h'),
...
(300, 'EXERCISE MAT', 'YOGA', 'YELLOW', NULL, 50.00, 0, 50, 'l'),
...
(314, 'TENNISBAL', 'Category', 'Size', 'Color', 10.00, 100, 10, 'h'),
...
(362, 'Yoga Block', '23x15', 'Paars', NULL, 10.00, 10, 50, 'l'),
...
(397, 'SPORT DRINK BOTTLE', 'Category', 'Size', 'Color', 20.00, 30, 10, 'l'),
...
(420, 'TENNIS BALLS', 'Category', 'Size', 'Color', 0.00, 0, 0, 'h'),
...
CREATE TABLE `purchases` (
    ...
    `purchase_date` DATE,
    CONSTRAINT `fk_purchases_customers` FOREIGN KEY (`customer_code`) REFERENCES `customers`(`customer_code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `purchase_line` (
    ...
    CONSTRAINT `fk_purchase_line_purchase` FOREIGN KEY (`purchase_number`) REFERENCES `purchases`(`purchase_number`),
...
-- Since `customer_supplier_code` can refer to either `customers` or `suppliers`, we can separate it into two columns.
...
CREATE TABLE `booking` (
  ...
  `supplier_code` INT DEFAULT NULL,
  `status` CHAR(1) DEFAULT NULL,
  PRIMARY KEY (`booking_number`),
  CONSTRAINT `fk_booking_customer` FOREIGN KEY (`customer_code`) REFERENCES `customers`(`customer_code`),
  CONSTRAINT `fk_booking_supplier` FOREIGN KEY (`supplier_code`) REFERENCES `suppliers`(`supplier_code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=26;

-- Data for table `booking`
-- Adjust your INSERT statements to specify either `customer_code` or `supplier_code`
-- For supplier bookings:
INSERT INTO `booking` (`booking_number`, `booking_date`, `amount`, `supplier_code`, `status`) VALUES
...
INSERT INTO `booking` (`booking_number`, `booking_date`, `amount`, `customer_code`, `status`) VALUES
...
-- Adjust your INSERT statements to include `sequence_number` or rely on the trigger
-- Example:
INSERT INTO `booking_line` (`booking_number`, `amount`) VALUES
(2, 602.50),
(3, 33.75),
(3, 83.75),
(4, 157.00),
...
CREATE TABLE `vat_percentage` (
  ...
  CONSTRAINT `fk_vat_percentage_vat` FOREIGN KEY (`type`) REFERENCES `vat`(`type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(121, 31, '2024-07-31', 25, 'A', 1, 1),
(121, 87, '2024-07-31', 50, 'A', 1, 1),
(121, 311, '2024-07-31', 50, 'A', 1, 1),
(121, 314, '2024-07-31', 150, 'A', 1, 1),
(121, 365, '2024-07-31', 150, 'A', 1, 1),
(121, 422, '2024-07-31', 25, 'A', 1, 1),
(174, 102, '2024-09-04', 25, 'A', 2, 1),
(174, 380, '2024-09-04', 25, 'A', 2, 1),
(174, 455, '2024-09-10', 50, 'A', 2, 2),
(174, 470, '2024-09-10', 25, 'A', 2, 2),
(175, 36, '2024-09-06', 30, 'A', 3, 1),
(175, 74, '2024-09-06', 20, 'A', 3, 1),
(175, 95, '2024-09-06', 100, 'A', 3, 1),
(175, 380, '2024-09-06', 15, 'A', 3, 1),
(175, 455, '2024-09-06', 50, 'A', 3, 1),
(175, 470, '2024-09-06', 25, 'A', 3, 1),
(175, 478, '2024-09-06', 50, 'A', 3, 1),
(175, 36, '2024-09-15', 20, 'A', 3, 2),
(175, 74, '2024-09-15', 40, 'A', 3, 2),
(175, 102, '2024-09-15', 10, 'A', 3, 2),
(175, 380, '2024-09-15', 12, 'A', 3, 2),
(175, 434, '2024-09-20', 25, 'A', 3, 3),
(175, 74, '2024-09-20', 40, 'A', 3, 3),
(175, 157, '2024-09-20', 400, 'A', 3, 3),
(175, 380, '2024-09-20', 23, 'A', 3, 3),
(175, 426, '2024-09-25', 250, 'A', 3, 4),
(181, 362, '2024-09-27', 20, 'A', 4, 1),
(181, 397, '2024-09-27', 5, 'A', 4, 1),
(184, 365, '2024-09-19', 85, 'A', 5, 1),
