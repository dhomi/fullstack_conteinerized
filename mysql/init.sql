...
(102, 'QA algemene sportartikelen', 'Sportlaan 1', '9728 jt', '045-6123789', 'Groningen', 'A', 1000.00, 0.00),
(103, 'QA fitness artikelen', 'Sportstraat 1', '1076 TW', '089-7654321', 'Amsterdam', 'A', 1000.00, 0.00);
...
add	Constraint 	fk_aank_plant	foreign key (artcode) references sportartikelen(artcode),
...
add	Constraint 	fk_aankr_pla  foreign key	(artcode) references sportartikelen(artcode);

alter table offertes
add Constraint 	fk_off_lev	  foreign key	(levcode) references leveranciers(levcode),
add	Constraint 	fk_off_art	  foreign key	(artcode) references sportartikelen(artcode);
...
add	Constraint 	fk_breg_art	  foreign key	(artcode) references sportartikelen(artcode);
